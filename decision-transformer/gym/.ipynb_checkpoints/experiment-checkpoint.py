...
root = "/home/jlw2247/DT/6998_Decision_Transformers/decision-transformer/gym"
root = "/home/jlw2247/DT/"
...
def experiment(
    ...
    # Test of initial save (Please comment out for real runs)
    iter = 0
    save_path = os.path.join(variant['model_savepath'],f'{model_type}_{env_name}_{str(args.K)}_{iter}.pt')
